...
// Change Top-Bar Color
	wp.customize( 'stc_top_bar_color', function( value ) {
		value.bind( function( to ) {
			$( '#inner-header>.large-12>.contain-to-grid, .top-bar, .top-bar-section li:not(.has-form) a:not(.button)' ).css( 'background', to );
		} );
	});
})( jQuery );
