<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="row">
					<div class="nav-wrapper-side">
						 <!-- This navs will be applied to the topbar, above all content 
							  To see additional nav styles, visit the /partials directory -->
						 <?php get_template_part( 'partials/nav', 'top-offcanvas' ); ?>
												<div class="social-side">
							<a id="facebook-2" class="social-side-sec" href="http://#">
								<svg version="1.1" id="facebook-shortcode-2" class="social-shortcode-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
<path d="M74.986,17.86l-9.058,0.004c-7.102,0-8.477,3.375-8.477,8.328v10.921h16.938l-0.005,17.106H57.451v43.894H39.784V54.219
	h-14.77V37.113h14.77V24.499c0-14.64,8.943-22.612,22.003-22.612l13.2,0.021V17.86z"/>
</svg>
								</a>
							<a id="twitter-2" class="social-side-sec" href="http://#">
								<svg version="1.1" id="twitter-shortcode-2" class="social-shortcode-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
<path d="M98.705,19.707c-0.139-0.165-0.371-0.221-0.568-0.131c-2.919,1.295-5.99,2.226-9.153,2.776
	...
	c3.843-2.811,7.141-6.252,9.802-10.235C98.857,20.11,98.844,19.873,98.705,19.707z"/>
</svg>
								</a>
							<a id="linkedin-2" class="social-side-sec" href="http://#">
								<svg version="1.1" id="twitter-shortcode-2" class="social-shortcode-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
<path d="M98.705,19.707c-0.139-0.165-0.371-0.221-0.568-0.131c-2.919,1.295-5.99,2.226-9.153,2.776
	c3.358-2.526,5.86-6.024,7.142-10.035c0.062-0.192-0.002-0.402-0.159-0.527c-0.158-0.125-0.377-0.141-0.55-0.038
	...
	c3.843-2.811,7.141-6.252,9.802-10.235C98.857,20.11,98.844,19.873,98.705,19.707z"/>
				    ...
				    <div id="main-side" class="large-8 medium-8 columns" role="main">
