 ...
 */
/*
	This is the the Ajaxy search bar. 
*/
...
class AjaxyLiveSearch {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'ajaxy-sf-search', get_template_directory_uri() ."/library/js/sf.js", array('jquery'), '1.0.1', true );
		wp_enqueue_script( 'ajaxy-sf-selective', get_template_directory_uri() ."/libraryjs/sf_selective.js", array('jquery'), '1.0.0', true );
		$this->enqueue_styles();
	}
	function head()
	{
