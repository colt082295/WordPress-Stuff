...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // adding Foundation scripts file in the footer
    wp_enqueue_script( 'foundation-js-offcanvas', get_template_directory_uri() . '/bower_components/foundation/js/foundation/foundation.offcanvas.js', array( 'jquery' ), $theme_version, true );
  
    // register main stylesheet
    wp_enqueue_style( 'joints-stylesheet', get_template_directory_uri() . '/library/css/style.css', array(), $theme_version, 'all' );

    // register main stylesheet
    wp_enqueue_style( 'lato-google-font', '//fonts.googleapis.com/css?family=Lato:400,700,900,400italic,700italic,900italic', array(), $theme_version, 'all' );
	...
	wp_enqueue_style( 'visual-composer-shortcodes', get_template_directory_uri() . '/vc_templates/css/style.css', array(), $theme_version, 'all' );
	
	wp_enqueue_script( 
		  'mytheme-themecustomizer',			//Give the script an ID
		  get_template_directory_uri().'/library/js/theme-customizer.js',//Point to file
    ...
    // Combine these all into one file. js and css. Use a gulp task for it.
    wp_enqueue_script( 'joints-js', get_template_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), $theme_version, true );

	wp_enqueue_style( 'joints-stylesheet', get_template_directory_uri() . '/bower_components/photoswipe/dist/default-skin/default-skin.css', array(), $theme_version, 'all' );
