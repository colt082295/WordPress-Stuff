...
<button class="button <?php echo esc_attr( $css_class ); ?> <?php echo esc_attr( $extra_css ); ?> <?php echo esc_attr( $button_shape ); ?> <?php echo esc_attr( $button_size ); ?> <?php echo esc_attr( $button_border ); ?> <?php echo esc_attr( $button_etc ); ?>" style="max-width:<?php echo esc_attr( $max_width ); ?>em; background:<?php echo esc_attr( $background_color ); ?>">
